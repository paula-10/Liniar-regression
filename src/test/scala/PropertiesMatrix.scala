...
//  def main(args: Array[String]): Unit = {
//
////    val mat = List(List(1.0, 2.0), List(3.0, 4.0), List(5.0, 6.0), List(7.0, 8.0))
////    val matrix = Matrix(mat)
////    val matrice1 = Matrix(Some(List(List(1.0, 2.0), List(3.0, 4.0))))
////    println("nr randuri: " + matrice1.height)
////    println("nr coloane: " + matrice1.width)
////    println("matricea: " + matrice1.toString)
//    val dataset = Dataset(System.getProperty("user.home") + "/PP/t1_v2/datasets/houseds.csv")
//    val matrice = Matrix(dataset)
//    println(matrice)
// }
